                    ...
                    messages=[
                        ChatCompletionSystemMessageParam(
                            content=(
                                ...
                                "If an UNCERTAIN_ROOT_CAUSE hypothesis lists possible root causes, require "
                                "each listed possibility to be directly supported as a causal mechanism. "
                                "When the evidence only supports symptoms or correlation, emit "
                                "UNSUPPORTED_CAUSAL_LEAP for the speculative possibilities rather than "
                                "accepting them as safe alternatives. "
